...
fn test_main() {
	...
	mut new_project := t.project_create_if_not_exist('team_test_new_updates', 'This is a team test project',
		taiga.Projectype.team) or { panic("Can't create project $err") }
	println('New Project: $new_project')
	t.issue_create('This is a new issue in project $new_project.id', new_project.id) or {
		panic("Can't create issue $err")
	}
