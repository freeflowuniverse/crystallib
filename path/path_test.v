...
fn test_parent() {
	...
	mut p := path.get('$testpath/newfile1')
	parent_dir := p.parent()
...
fn test_parent_find() {
	...
	mut test_path_dir := path.get('$testpath')
	mut p := path.get('$testpath/test_parent')
	mut p2 := path.get('$testpath/test_parent/newfile1')
...
fn test_write_and_read() {
	...
	mut fp := path.get('$testpath/newfile1')
...
fn test_copy() {
	...
	mut dest_dir := path.get('$testpath/test_parent')
	mut src_f := path.get('$testpath/newfile1')
